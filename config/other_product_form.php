...
if (!empty($_POST)) {
    ...
    // AJOUTER UN PRODUIT
    if(isset($_POST['form']) && $_POST['form'] === 'OtherProduct') {
    ...
    // GESTION DU STOCK
    if (isset($_POST['form']) && ($_POST['form'] === 'addOther') || ($_POST['form'] === 'removeOther')) {
    ...
    if (isset($_POST['form']) && $_POST['form'] === 'deleteOther') {
